...
(define (fn-for-element e)
  (... (elt-name e)                  ;String
       (elt-data e)                  ;Number
       (fn-for-loe (elt-subs e))))   ;non-primitive type
...
;; Template rules used:
;; Element is compound: 3 fields
;; subs is of non-primitive type

;; ListOfElement is one of: 2 cases
;; one of 2 cases
;; - atomic distinct empty
;; compound: (cons Element ListOfElement)
;; -reference: (first loe) is Element
;; self-refernce: (rest loe ) is ListOfElement
